...
namespace OneOpsServer.Api
{
    ...
    {
        public string CreateMessgaeUrl { get; set; }
        public string PublishMessgaeUrl { get; set; }
        public string RollbackMessageUrl { get; set; }

        public string DeleteMessageUrl { get; set; }
        public int MaxRollbackPackagesCount { get; set; }
